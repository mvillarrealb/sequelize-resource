    ...
    get before() {
      if(!this._before) {
        if( this.middleware && this.middleware.before ) {
          ...
          } else if( this.isArray(this.middleware.before) ) {
            middleware = this.middleware.before;
            this.beforeMiddlewareType = CrudController.MIDDLEWARE_GLOBAL;
       ...
       if( this.beforeMiddlewareType == CrudController.MIDDLEWARE_LOCAL ) {
         if(this.before.findOne) {
           if(this.isArray(this.before.findOne)){
             findOne = findOne.concat(this.before.findOne);
         ...
         if(this.before.findAll) {
           if(this.isArray(this.before.findAll)){
             findAll = findAll.concat(this.before.findAll);
         ...
         if(this.before.create) {
           if(this.isArray(this.before.create)){
             create = create.concat(this.before.create);
         ...
         if(this.before.destroy) {
           if(this.isArray(this.before.destroy)){
             destroy = destroy.concat(this.before.destroy);
         ...
         if( this.before.update ) {
           if(this.isArray(this.before.update)){
             update = update.concat(this.before.update);
         ...
         if(this.before.bulkCreate) {
           if(this.isArray(this.before.bulkCreate)){
             bulkCreate = bulkCreate.concat(this.before.bulkCreate);
         ...
         findOne,findAll,create,update,destroy, bulkCreate = [];
         findOne = findOne.concat(this.before);
         findAll = findAll.concat(this.before);
         create = create.concat(this.before);
         update = update.concat(this.before);
         destroy = destroy.concat(this.before);
         bulkCreate = bulkCreate.concat(this.before);
       }
     }
